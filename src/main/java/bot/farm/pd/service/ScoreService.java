...
import static bot.farm.pd.util.DiceUtil.isFullHouse;
import static bot.farm.pd.util.DiceUtil.isLargeStraight;
import static bot.farm.pd.util.DiceUtil.isPoker;
import static bot.farm.pd.util.DiceUtil.isSequence;
import static bot.farm.pd.util.DiceUtil.isSmallStraight;
import static bot.farm.pd.util.DiceUtil.isTwoPair;
import static bot.farm.pd.util.DiceUtil.scoreTwoPair;
import static bot.farm.pd.util.DiceUtil.sequenceScore;
